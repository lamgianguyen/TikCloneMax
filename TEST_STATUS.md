...
## 🤖 AUTO QA RUN — 2026-06-10 15:05 (run 20260610-150511)

> Tự sinh bởi `qa/run-all.js`. PASS=53 FAIL=0 SKIP=0 · backend UP · 67ms. Block này bị GHI ĐÈ mỗi run — đừng sửa tay.
...
| gate.overlaycard.coinmatchbg | L4 Gate-drift | ✅ PASS | Gate Overlay-Layout anchor '/widget/coinmatch' present (2 hits in templates/earlyCss.txt) |
